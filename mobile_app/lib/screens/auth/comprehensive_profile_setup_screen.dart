      ...
      if (existingProfile != null) {
        ...
        setState(() {
          ...
          if (existingProfile.academicInfo != null) {
            ...
            _selectedFaculty = existingProfile.academicInfo!.faculty;
            ...
            children: [
              ...
              SizedBox(
                ...
                child: DropdownButtonFormField<String>(
                  ...
                  isExpanded: true,
                  items: _getDepartmentsByFaculty(_selectedFaculty)
              ...
              // Program
              TextFormField(
                controller: TextEditingController(text: _selectedProgram),
                decoration: const InputDecoration(
                  labelText: 'Program *',
                  border: OutlineInputBorder(),
