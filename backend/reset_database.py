...
def insert_sample_data():
    ...
    try:
        ...
        db.add_all(profiles)
        db.commit()
        print(f"✅ Created {len(profiles)} sample profiles")
        ...
        db.add_all(posts)
        db.commit()
        print(f"✅ Created {len(posts)} sample showcase posts")
